                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <DialogDescription className="flex items-center gap-2 mt-0.5 text-xs">
                                    <Calendar className="size-3.5" /> Emitido em: {emissao}
                                </DialogDescription>
                            </div>
                        </div>
                ...
                <div className="overflow-y-auto custom-scrollbar p-6 space-y-6 text-xs flex-1">
                    ...
                    <div className="p-4 rounded-xl border border-border/60 bg-muted/20">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div className="p-3 bg-card rounded-lg border border-border/40">
                                <span className="text-[10px] text-muted-foreground block font-medium">Ponto de Partida</span>
                                <p className="font-semibold text-sm mt-0.5">{partida}</p>
                            </div>
                            <div className="p-3 bg-card rounded-lg border border-border/40">
                                <span className="text-[10px] text-muted-foreground block font-medium">Ponto de Destino</span>
                    ...
                    <div className="p-4 rounded-xl border border-border/60 bg-card">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                            <div className="p-2.5 bg-muted/30 rounded-lg">
                                <span className="text-muted-foreground block text-[10px]">Número</span>
                                <p className="font-mono font-bold text-sm text-foreground">{numerocontainer}</p>
                            </div>
                            <div className="p-2.5 bg-muted/30 rounded-lg">
                                <span className="text-muted-foreground block text-[10px]">Tipo/Tamanho</span>
                                <p className="font-semibold text-sm">{container}</p>
                            </div>
                            <div className="p-2.5 bg-muted/30 rounded-lg">
                                <span className="text-muted-foreground block text-[10px]">Nº Lacre</span>
                                <p className="font-mono font-medium text-sm">{dadosFicticios.lacreContainer}</p>
                            </div>
                            <div className="p-2.5 bg-muted/30 rounded-lg">
                                <span className="text-muted-foreground block text-[10px]">Peso Bruto</span>
                                <p className="font-semibold text-sm">{dadosFicticios.pesoBrutoKg.toLocaleString("pt-BR")} Kg</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="p-4 rounded-xl border border-border/60 bg-card space-y-2">
                            ...
                            <div className="p-2.5 bg-muted/20 rounded-lg space-y-2">
                                <div>
                                    <span className="text-muted-foreground text-[10px]">Nome Completo:</span>
                                ...
                                <div className="grid grid-cols-2 gap-2 text-xs pt-1 border-t border-border/30">
                                    <div>
                                        ...
                                        <p className="font-mono font-medium">{dadosFicticios.cpfMotorista}</p>
                                    </div>
                                    <div>
                                        <span className="text-muted-foreground text-[10px]">Contato:</span>
                                        <p className="font-medium">{dadosFicticios.telefoneMotorista}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="p-4 rounded-xl border border-border/60 bg-card space-y-2">
                            ...
                            <div className="p-2.5 bg-muted/20 rounded-lg space-y-2">
                                <div>
                                    <span className="text-muted-foreground text-[10px]">Caminhão / Modelo:</span>
                                    <p className="font-semibold text-sm">{caminhao}</p>
                                </div>
                                <div className="grid grid-cols-2 gap-2 text-xs pt-1 border-t border-border/30">
                                    <div>
                                        <span className="text-muted-foreground text-[10px]">Placa Cavalo:</span>
                                        <p className="font-mono font-bold text-primary">{placa}</p>
                                    </div>
                                    <div>
                                        <span className="text-muted-foreground text-[10px]">Placa Carreta:</span>
                                        <p className="font-mono font-bold">{dadosFicticios.placaCarreta}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="p-4 rounded-xl border border-border/60 bg-card space-y-3">
                        ...
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-3 bg-muted/30 p-3 rounded-lg">
                            <div>
                                <span className="text-muted-foreground block text-[10px]">Nº da Nota</span>
                                <p className="font-mono font-bold text-sm">{notaFiscal}</p>
                            </div>
                            <div>
                                <span className="text-muted-foreground block text-[10px]">Valor Declarado</span>
                                <p className="font-semibold text-sm text-emerald-600 dark:text-emerald-400">
                                    R$ {dadosFicticios.valorDeclaradoNFe.toLocaleString("pt-BR", { minimumFractionDigits: 2 })}
                                </p>
                            </div>
                            <div className="col-span-2 md:col-span-1">
                                <span className="text-muted-foreground block text-[10px]">Empresa Emissora</span>
                                <p className="font-medium text-sm truncate">{dadosFicticios.empresaEmissora}</p>
                            </div>
                        </div>
